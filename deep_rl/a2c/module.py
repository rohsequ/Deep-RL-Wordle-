...
class AdvantageActorCritic(LightningModule):
    ...
    def __init__(
        ...
        self.agent = ActorCriticAgent(self.net, word_list=self.env.words)
    ...
    def _dataloader(self) -> DataLoader:
        ...
        dataloader = DataLoader(dataset=dataset, batch_size=self.hparams.batch_size) #, num_workers=self.hparams.num_workers)
        return dataloader
    ...
    def add_model_specific_args(arg_parser: ArgumentParser) -> ArgumentParser:
        ...
        arg_parser.add_argument("--hidden_size", type=int, default="128", help="Width of hidden layers")
        ...
        arg_parser.add_argument("--num_workers", type=int, default=0., help="Set num_workers to number of CPU cores. (Half of it)")
